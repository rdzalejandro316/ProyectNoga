...
namespace SiasoftAppExt
{
    ...
    public partial class AnalisisDeCuentasPorPagar : UserControl
    {
        ...
        private DataSet SlowDude(string ffi, string ctas, string cter, string cco, string where, int exclinteremp, CancellationToken cancellationToken)
        {
            try
            {
                DataSet jj = LoadData(ffi, ctas, cter, cco, where,exclinteremp ,cancellationToken);
                return jj;
        ...
        private DataSet LoadData(string Fi, string ctas, string cter, string cco, string where,int exclinteremp, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private void BtnDetalle_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                //MessageBox.Show(cod_cli + "-cuenta:" + cod_cta);
        ...
        private void ReImprimir_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                //@TipoReporte = 0,	@ExcluirInterEmpresa = 0
                ...
                string TituloReport = "Cuentas por Pagar Resumida - Reporte:"+TipoReporte+" - ";
                if (CmbTipoDoc.SelectedIndex == 1) TituloReport = "Cuentas por Pagar Detallada - Reporte:"+TipoReporte+" - ";

                ReporteCxP r = new ReporteCxP(parameters, TipoReporte);
