    ...
    public partial class AnalisisDeCuentasPorPagarDetalle : Window
    {
        ...
        private void ReImprimir_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                SiaWin.seguridad.Auditor(0, SiaWin._ProyectId, SiaWin._UserId, SiaWin._UserGroup, idemp, 0, 0, 0, "Consulto Cartera - Imprimio :" + cta + " Fecha:" + paramfechaini + " - " + " Reporte:" + TipoReporte, "");
                string TituloReport = "Cuentas por Cobrar Detallada -Reporte:"+TipoReporte+" - ";
