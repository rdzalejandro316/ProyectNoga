...
{
    public class ReportDirect : PrintDocument, IDisposable
    {
        private PageSettings m_pageSettings;
        private int m_currentPage;
        private List<Stream> m_pages = new List<Stream>();

        public ReportDirect(ServerReport serverReport) : this((Report)serverReport)
        {
            RenderAllServerReportPages(serverReport);
        }
        public ReportDirect(LocalReport localReport) : this((Report)localReport)
        {
...
protected override void OnPrintPage(PrintPageEventArgs e)
        ...
        private void RenderAllServerReportPages(ServerReport serverReport)
        {
            ...
            {
                System.Windows.MessageBox.Show("possible missing information :: " + e);
            }
        }
        ...
        public void Dispose()
        {
            if (m_pages != null)
            {
                foreach (Stream stream in m_pages)
                    stream.Close();
            }
        }
