...
namespace SiasoftAppExt
{
    ...
    //Sia.PublicarPnt(9671,"AnalisisVentaWindows");
    public partial class AnalisisVentaWindows : Window
    {
        dynamic SiaWin;
        public int idemp = 0;
        int moduloid = 0;
        ...
        private void LoadConfig()
        {
            try
            {
                ...
                this.Title = "Analisis de ventas " + nomempresa;
        ...
        public void llenarTotales(double p1, double p2, double p3, double p4, double ca)
        {
            ...
            TextCantidad10.Text = ca.ToString();
            TextSubtotal10.Text = p1.ToString("C");
            TextDescuento10.Text = p2.ToString("C");
            TextIva10.Text = p3.ToString("C");
        ...
        private void dataGrid_FilterChanged(object sender, GridFilterEventArgs e)
        {
            try
            {
                ...
                if (tag == "10")
                {
                    TextCantidad10.Text = cantidadX.ToString();
                    TextSubtotal10.Text = subtotalX.ToString("C");
                    TextDescuento10.Text = descuentoX.ToString("C");
                    TextIva10.Text = ivaX.ToString("C");
                    TextTotal10.Text = totalX.ToString("C");
                    Total10.Text = VentasProvedor.View.Records.Count.ToString();
                }
