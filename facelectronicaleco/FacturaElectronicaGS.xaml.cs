...
{
    //Sia.PublicarPnt(9627,"FacturaElectronicaGS");
    //dynamic ww = ((Inicio)Application.Current.MainWindow).WindowExt(9627,"FacturaElectronicaGS");    
    ...
    public partial class FacturaElectronicaGS : Window
    {
        ...
        private FacturaGeneral BuildFactura()
        {
            try
            {
                ...
                cliente.email = "ceroseis26@gmail.com";
 ...
 //               String Tipo_Documento = "";
                ...
                if(Convert.ToDecimal(dsImprimir.Tables[2].Rows[0]["val_des"].ToString().Trim())>1111111111111110)
                {
...
//        private void BtnEnviar_Click(object sender, EventArgs e)
 ...
 //               factura.fechaEmision = "2019-12-01 07:36:01";
        ...
        //    {
        //        FileInfo file = new FileInfo("archivoatrasnmitir");
        //        if (file.Exists)
        //        {
        ...
        //            correoEntrega[0] = "email@dominio.com";
